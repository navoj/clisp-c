; -*- Mode: Common Lisp; Package: (CL-C Global) -*-
; File: CLINIT.LISP
;
...
; (defconst *rubout-handler-message* #+Symbolics ':input-editor #-Symbolics ':rubout-handler)
(defconst *rubout-handler-message* ':input-editor)
